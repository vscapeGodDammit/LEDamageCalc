...
Construct() {
	...
	Edit2 := myGui.Add("Edit", "x304 y256 w209 h20 +ReadOnly", "(5+Chance to crit) * (1+(Inc Crit / 100))")
	...
	OnEventHandler(*)
	{
		...
		(1 + (0 + Edit8.Value / 100)) * 
		(1 + (0 + Edit9.Value / 100)) * 
		(1 + (0 + Edit10.Value / 100)) * 
		(1 + (0 + Edit11.Value / 100)) * 
		(1 + ((0 + Edit12.Value / 100)))) * 
		(1 + ((0 + Edit13.Value / 100) * (0 + Edit14.Value / 100)))
		)
